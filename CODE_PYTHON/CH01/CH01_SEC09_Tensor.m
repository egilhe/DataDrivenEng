% This code requires the parafac() function from the N-way Toolbox,
% available at https://www.mathworks.com/matlabcentral/fileexchange/1088-the-n-way-toolbox
% Download and unzip nway320_exchange into the UTILS directory

clear all; close all; clc

addpath(fullfile('..','UTILS','nway320_exchange'));
